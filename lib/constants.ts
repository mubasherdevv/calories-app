...
export const APP_TAGLINE = 'Instant Calorie & Macro AI Tracker'

/** Short description used in marketing / onboarding contexts. */
export const APP_DESCRIPTION =
  'Snap a photo of your plate to instantly analyze calories, protein, carbs, and fats using state-of-the-art vision AI. Track your daily goals, monitor macro rings, and maintain your streak.'
